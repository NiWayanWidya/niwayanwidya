GCV<-function(data_harga_cabai_Surabaya){
  t<- data_harga_cabai_Surabaya[,1]
  Y<- data_harga_cabai_Surabaya[,2]
  n<-length(Y)
...
GCV(data_harga_cabai_Surabaya)


estimasi<-function(data_harga_cabai_Surabaya){
  t<- data_harga_cabai_Surabaya[,1]
  Y<- data_harga_cabai_Surabaya[,2]
  n<-length(t)
...
estimasi(data_harga_cabai_Surabaya)